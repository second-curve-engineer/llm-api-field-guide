...
[在线页面](https://second-curve-engineer.github.io/llm-api-field-guide/) | [English README](README.en.md)

面向 Agent Runtime 实现的 OpenAI Chat Completions 与 Anthropic Messages API 对照：请求参数、返回结构、Tool Calling、Streaming、Structured Output 与 Agent Loop 关键判断点。
